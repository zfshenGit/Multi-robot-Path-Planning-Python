        ...
        for y in range(0, CUBE_SIZE+1, 2):
            ...
            for z in range(0, CUBE_SIZE+1, 2):
                ...
                if sum((edge_x, edge_y, edge_z)) >= 2:
                    ...
                    start_end_list = [(4, 1, 2),(2, 1, 2),(2, 1, 4),(4, 1, 4),(4, 5, 2),(2, 5, 2),(2, 5, 4),(4, 5, 4)]
                    ...
                    # start_end_points = point(start_end_points,x,y,z,start_end_list[1][0],start_end_list[1][1],start_end_list[1][2]) 
                    
                    obstacle_list = [(3, 3, 2),(3, 3, 3), (3, 3, 4)]
                    obstacle_points = point(obstacle_points,x,y,z,obstacle_list[0][0],obstacle_list[0][1],obstacle_list[0][2])
                    obstacle_points = point(obstacle_points,x,y,z,obstacle_list[1][0],obstacle_list[1][1],obstacle_list[1][2]) 
                    obstacle_points = point(obstacle_points,x,y,z,obstacle_list[2][0],obstacle_list[2][1],obstacle_list[2][2]) 
                    
                    # path_list = [(1, 1, 3), (1, 2, 3), (2, 3, 3), (2, 4, 3), (3, 5, 3), (4, 5, 3), (5, 5, 3)]
                    path_points = point(path_points,x,y,z,path_list1[m][0],path_list1[m][1],path_list1[m][2])
                    path_points = point(path_points,x,y,z,path_list2[m][0],path_list2[m][1],path_list2[m][2])
                    path_points = point(path_points,x,y,z,path_list3[m][0],path_list3[m][1],path_list3[m][2])
                    path_points = point(path_points,x,y,z,path_list4[m][0],path_list4[m][1],path_list4[m][2])
...
def run(paths1,paths2,paths3,paths4):
    ...
    while True:
        points,start_end_points,obstacle_points,path_points = back(m,paths1,paths2,paths3,paths4)
