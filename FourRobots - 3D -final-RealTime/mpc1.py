...
def predictbm(node,_3dmap):#该代码表示向最下层中间节点
    try:
        if ((_3dmap[node.x][node.y - 1][node.z] == '0') and (_3dmap[node.x][node.y - 2][node.z] == '0' or _3dmap[node.x][node.y - 2][node.z] == '3' or _3dmap[node.x][node.y - 2][node.z] == '5' or _3dmap[node.x][node.y - 2][node.z] == '7' or _3dmap[node.x][node.y - 2][node.z] == '2')):
            flag =0                         #下一步为空闲状态，并且下下一步为空闲状态或其他机器人的当前位置或R1的目标点
            flag2 = 0
...
def predictbr(node,_3dmap):#该代码表示向最下层右节点
    try:
        if ((_3dmap[node.x + 1][node.y - 1][node.z] == '0') and (_3dmap[node.x + 2][node.y - 2][node.z] == '0' or _3dmap[node.x + 2][node.y - 2][node.z] == '3' or _3dmap[node.x + 2][node.y - 2][node.z] == '5' or _3dmap[node.x + 2][node.y - 2][node.z] == '7' or _3dmap[node.x + 2][node.y - 2][node.z] == '2')):
            flag2 = 0
            if (_3dmap[node.x][node.y - 1][node.z] == '9' or _3dmap[node.x + 1][node.y][node.z] == '9' or _3dmap[node.x + 1][node.y - 2][node.z] == '9' or _3dmap[node.x + 2][node.y - 1][node.z] == '9'):
                flag2 = 1
            else:
                pass
            flag = 0
...
def predictbu(node,_3dmap):#该代码表示最下层向上
    try:
        if ((_3dmap[node.x][node.y - 1][node.z - 1] == '0') and (_3dmap[node.x][node.y - 2][node.z - 2] == '0' or _3dmap[node.x][node.y - 2][node.z - 2] == '3' or _3dmap[node.x][node.y - 2][node.z - 2] == '5' or _3dmap[node.x][node.y - 2][node.z - 2] == '7' or _3dmap[node.x][node.y - 2][node.z - 2] == '2')):
            flag2 = 0
            if (_3dmap[node.x][node.y - 1][node.z] == '9' or _3dmap[node.x][node.y][node.z - 1] == '9' or _3dmap[node.x][node.y - 2][node.z -1] == '9' or _3dmap[node.x][node.y - 1][node.z - 2] == '9'):
                flag2 = 1
            else:
                pass
            flag = 0
...
def predictbrd(node,_3dmap): #该代码表示最下层向右下，则向右上，向左下，向左上同理
    try:
        if (_3dmap[node.x + 1][node.y - 1][node.z + 1] == '0' and (_3dmap[node.x + 2][node.y - 2][node.z + 2] == '0' or _3dmap[node.x + 2][node.y - 2][node.z + 2] == '3' or _3dmap[node.x + 2][node.y - 2][node.z + 2] == '5' or _3dmap[node.x + 2][node.y - 2][node.z + 2] == '7' or _3dmap[node.x + 2][node.y - 2][node.z + 2] == '2')):
            flag2 = 0
            if (_3dmap[node.x][node.y - 1][node.z] == '9' or _3dmap[node.x][node.y - 1][node.z + 1] == '9' or _3dmap[node.x + 1][node.y - 1][node.z] == '9' or _3dmap[node.x + 1][node.y][node.z] == '9' or _3dmap[node.x][node.y][node.z + 1] == '9' or _3dmap[node.x + 1][node.y][node.z + 1] == '9' or _3dmap[node.x + 1][node.y - 2][node.z + 1] == '9' or _3dmap[node.x + 1][node.y - 2][node.z + 2] == '9' or _3dmap[node.x + 2][node.y - 2][node.z + 1] == '9' or _3dmap[node.x + 2][node.y - 1][node.z + 1] == '9' or _3dmap[node.x + 1][node.y - 1][node.z + 2] == '9' or _3dmap[node.x + 2][node.y - 1][node.z + 2] == '9'):
                flag2 = 1
            else:
                pass
            flag = 0
...
def predictmr(node,_3dmap):#该代码表示向中间层右节点
    try:
        if ((_3dmap[node.x + 1][node.y][node.z] == '0') and (_3dmap[node.x + 2][node.y][node.z] == '0' or _3dmap[node.x + 2][node.y][node.z] == '3' or _3dmap[node.x + 2][node.y][node.z] == '5' or _3dmap[node.x + 2][node.y][node.z] == '7' or _3dmap[node.x + 2][node.y][node.z] == '2')):
...
def predictmu(node,_3dmap):#该代码表示中间层向上
    try:
        if ((_3dmap[node.x][node.y][node.z - 1] == '0') and (_3dmap[node.x][node.y][node.z - 2] == '0' or _3dmap[node.x][node.y][node.z - 2] == '3' or _3dmap[node.x][node.y][node.z - 2] == '5' or _3dmap[node.x][node.y][node.z - 2] == '7' or _3dmap[node.x][node.y][node.z - 2] == '2')):
...
def predictmrd(node,_3dmap): #该代码表示中间层向右下，则向右上，向左下，向左上同理
    try:
        if (_3dmap[node.x + 1][node.y][node.z + 1] == '0' and (_3dmap[node.x + 2][node.y ][node.z + 2] == '0' or _3dmap[node.x + 2][node.y ][node.z + 2] == '3' or _3dmap[node.x + 2][node.y ][node.z + 2] == '5' or _3dmap[node.x + 2][node.y ][node.z + 2] == '7' or _3dmap[node.x + 2][node.y ][node.z + 2] == '2')):
            flag2 = 0
            if (_3dmap[node.x + 1][node.y][node.z] == '9' or _3dmap[node.x][node.y][node.z + 1] == '9' or _3dmap[node.x + 2][node.y][node.z + 1] == '9' or _3dmap[node.x + 1][node.y][node.z + 2] == '9'):
                flag2 = 1
            else:
                pass
            flag = 0
...
def predicttl(node,_3dmap):#该代码表示最上层向左
    try:
        if ((_3dmap[node.x - 1][node.y + 1][node.z] == '0') and (_3dmap[node.x - 2][node.y + 2][node.z] == '0' or _3dmap[node.x - 2][node.y + 2][node.z] == '3' or _3dmap[node.x - 2][node.y + 2][node.z] == '5' or _3dmap[node.x - 2][node.y + 2][node.z] == '7' or _3dmap[node.x - 2][node.y + 2][node.z] == '2')):
            flag2 = 0
            if (_3dmap[node.x - 1][node.y][node.z] == '9' or _3dmap[node.x][node.y + 1][node.z] == '9' or _3dmap[node.x - 2][node.y + 1][node.z] == '9' or _3dmap[node.x - 1][node.y + 2][node.z] == '9'):
                flag2 = 1
            else:
                pass
            flag = 0
...
def predicttu(node,_3dmap):#该代码表示最上层向上
    try:
        if ((_3dmap[node.x][node.y + 1][node.z - 1] == '0') and (_3dmap[node.x][node.y + 2][node.z - 2] == '0' or _3dmap[node.x][node.y + 2][node.z - 2] == '3' or _3dmap[node.x][node.y + 2][node.z - 2] == '5' or _3dmap[node.x][node.y + 2][node.z - 2] == '7' or _3dmap[node.x][node.y + 2][node.z - 2] == '2')):
            flag2 = 0
            if (_3dmap[node.x][node.y][node.z - 1] == '9' or _3dmap[node.x][node.y + 1][node.z] == '9' or _3dmap[node.x][node.y + 1][node.z - 2] == '9' or _3dmap[node.x][node.y + 2][node.z - 1] == '9'):
                flag2 = 1
            else:
                pass
            flag = 0
...
def preset_map():
    ...
    _3dmap2.append('0 0 3 0 5 0 0'.split())
    _3dmap2.append('0 0 0 0 0 0 0'.split())
    _3dmap2.append('0 0 9 9 9 0 0'.split())
    _3dmap2.append('0 0 0 0 0 0 0'.split())
    _3dmap2.append('0 0 4 0 6 0 0'.split())
    _3dmap2.append('0 0 0 0 0 0 0'.split())
    _3dmap3 = []
    ...
    _3dmap4.append('0 0 1 0 7 0 0'.split())
    _3dmap4.append('0 0 0 0 0 0 0'.split())
    _3dmap4.append('0 0 0 0 0 0 0'.split())
    _3dmap4.append('0 0 0 0 0 0 0'.split())
    _3dmap4.append('0 0 2 0 8 0 0'.split())
    _3dmap4.append('0 0 0 0 0 0 0'.split())
    _3dmap5 = []
...
# def preset_map():
    ...
    # #沿着x轴方向的7层分别由_3dmap1-_3dmap7共9个列表存储
    # _3dmap1 = []
    # _3dmap1.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap1.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap1.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap1.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap1.append('0 0 0 0 0 0 0 0 0'.split())
    ...
    # _3dmap1.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap2 = []
    # _3dmap2.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap2.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap2.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap2.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap2.append('0 0 0 0 0 0 0 0 0'.split())
    ...
    # _3dmap2.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap3 = []
    # _3dmap3.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap3.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap3.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap3.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap3.append('0 0 0 0 0 0 0 0 0'.split())
    ...
    # _3dmap3.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap4 = []
    # _3dmap4.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap4.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap4.append('0 0 0 3 0 5 0 0 0'.split())
    # _3dmap4.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap4.append('0 0 0 9 9 9 0 0 0'.split())
    # _3dmap4.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap4.append('0 0 0 4 0 6 0 0 0'.split())
    # _3dmap4.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap4.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap5 = []
    # _3dmap5.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap5.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap5.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap5.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap5.append('0 0 0 0 0 0 0 0 0'.split())
    ...
    # _3dmap5.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap6 = []
    # _3dmap6.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap6.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap6.append('0 0 0 1 0 7 0 0 0'.split())
    # _3dmap6.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap6.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap6.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap6.append('0 0 0 2 0 8 0 0 0'.split())
    # _3dmap6.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap6.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap7 = []
    # _3dmap7.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap7.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap7.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap7.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap7.append('0 0 0 0 0 0 0 0 0'.split())
    ...
    # _3dmap7.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap8 = []
    # _3dmap8.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap8.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap8.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap8.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap8.append('0 0 0 0 0 0 0 0 0'.split())
    ...
    # _3dmap8.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap9 = []
    # _3dmap9.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap9.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap9.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap9.append('0 0 0 0 0 0 0 0 0'.split())
    # _3dmap9.append('0 0 0 0 0 0 0 0 0'.split())
    ...
    # _3dmap.append(_3dmap6)
    # _3dmap.append(_3dmap7)
    # _3dmap.append(_3dmap8)
    # _3dmap.append(_3dmap9)
    # map_border = (len(_3dmap),len(_3dmap[0]),len(_3dmap[0][0]))
    # return _3dmap
